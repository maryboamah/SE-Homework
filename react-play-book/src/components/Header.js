...
// get search value with submit button 
    ...
    return(<div className="header">
        ...
        <div id="search"> <select id="select">
        <option value = ""> ...Select..  
                </option>  
            <option value = "inauthor"> Author  
            </option>  
            <option value = "intitle"> Title  
            </option>  
            <option value = "inpublisher"> Publisher 
            </option>  
            <option value = "subject"> Subject  
            </option>  
          
        <option value = "isbn"> ISBN  </option>  
        </select><input type="text" placeholder="Search by Title/Author/ISBN"  className="text" id='text' ></input>
        <Link to ="searchresult">
        <button type="submit" id="submit"onClick={() => {navigate("/searchresult")}}>Submit</button>
        </Link></div>
        
        <img src="favorite.png" alt="favorite" id="favorite"></img><p id='test'></p>

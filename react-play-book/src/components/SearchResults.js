...
function SearchResults(props){
    ...
    const {data3} = FetchData(`https://www.googleapis.com/books/v1/volumes?q=${props.userValue}+${props.selectValue}&maxResults=20&key=AIzaSyBwnJ8SVW--D44GOqK3qQU3ZP6TEOAYQuY`)
    console.log(props.userValue)
...
<button className='preview' ><a href={`${props.preview}`}>Google Preview</a> </button>
                  ...
                  <legend id="loadmore1">{visible3 < data3.items.length && (

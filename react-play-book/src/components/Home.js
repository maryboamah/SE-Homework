...
function Home() {
  ...
  const { data1 } = FetchData(
    `https://www.googleapis.com/books/v1/volumes?q=+inauthor&maxResults=20&orderBy=newest&key=AIzaSyBRrOnOtT1e--wOhPagUSD8JBwkYmyyymc`
  );
  //data for new books
